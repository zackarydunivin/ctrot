...
class Phrase2Vec:
    ...
    def from_word2vec_paths(cls, dim, w2v_path='/data/word2vec/GoogleNews-vectors-negative300.bin',
        ...
        w2v = gs.KeyedVectors.load_word2vec_format(w2v_path, binary=True, unicode_errors='ignore')
        if e2v_path is not None:
            e2v = gs.Word2Vec.load_word2vec_format(e2v_path, binary=True, unicode_errors='ignore')
        else:
            e2v = dict()
